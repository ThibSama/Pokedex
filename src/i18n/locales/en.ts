...
const en: LocaleResource = {
  ...
  pokedex: {
    ...
    searchHint:
      "Filters the list by French name, English name or Pokédex number",
    sort: {
      label: "Sort order",
  ...
  collection: {
    ...
    emptyBody:
      "Open a Pokémon’s entry and tap the heart to add it to your collection.",
  ...
  detail: {
    ...
    invalidIdBody:
      "“{{value}}” is not a National Pokédex number ({{min}}–{{max}}).",
